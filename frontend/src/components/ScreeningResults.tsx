...
export default function ScreeningResults({
  ...
  const rankMedal = (rank: number) => {
    if (rank === 1) return { bg: "linear-gradient(135deg, #f59e0b, #d97706)", text: "#fff", label: "#1" };
    if (rank === 2) return { bg: "linear-gradient(135deg, #94a3b8, #64748b)", text: "#fff", label: "#2" };
    if (rank === 3) return { bg: "linear-gradient(135deg, #d97706, #b45309)", text: "#fff", label: "#3" };
